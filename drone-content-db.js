// https://drone.zendin.co.uk


// Last upload date
const upload_date = "Jun, 2023";

// Posts (one array per location, one array in media[i][2] per file)
const media = [
